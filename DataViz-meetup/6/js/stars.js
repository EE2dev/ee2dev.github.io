...
// adjusted by a couple of lines to optionally switch off requestAnimationFrame calls after animation is finished
...
var App = /** @class */ (function () {
    function App(options) {
        ...
        this.activate = true; // 1) new to turn off/on requestAnimationFrame call;
        this.buffer = document.createElement("canvas");
        this.bufferContext = this.buffer.getContext("2d");
        this.supportsFilters = (typeof this.bufferContext.filter !== "undefined");
        this.setActivate = function(b) {_this.activate = b;}
        ...
        this.render = function (time) {
            ...
            context.drawImage(_this.buffer, 0, 0);
            context.filter = "none";
           // 2) quickSettings.setValue("Particles", "\n      Active = " + _this.particles.length + "<br>\n      Cached = " + _this.pool.length);
            if (_this.activate) {
