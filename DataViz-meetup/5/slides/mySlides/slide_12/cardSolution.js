pt.cardSolution = pt.cardSolution || {};

pt.cardSolution.init = function() {
		var maxNumber = 60;
		...
		var myDiv = d3.select("#cardSolution div.center");
		/*
		...
		*/
		...
		var svg = d3.select("section#cardSolution").append("svg")
			.attr("width", width)
			.attr("height", height)
		...
		function nextCard(d, i) {
			...
			d3.select(".card.c" + currentCard)
				...
				myDiv.append("h3").text("Please focus on the screen!").attr("class", "middle");
